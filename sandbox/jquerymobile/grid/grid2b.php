<?php
/*
 * @file sandbox/jquerymobile/grid/grid2b.php
...
<div data-role="page" id="page1" data-fullscreen="true"><!--page-->
	...
	<div role="main" class="ui-content"><!--ui-content-->
		...
		<div class="ui-grid-d">
			<div class="ui-block-a"><div class="ui-bar ui-bar-a" style="height:200px">Block A</div></div>
			<div class="ui-block-b"><div class="ui-bar ui-bar-a" style="height:200px">Block B</div></div>
			<div class="ui-block-c"><div class="ui-bar ui-bar-a" style="height:200px">Block C</div></div>
			<div class="ui-block-d"><div class="ui-bar ui-bar-a" style="height:200px">Block D</div></div>
			<div class="ui-block-e"><div class="ui-bar ui-bar-a" style="height:200px">Block E</div></div>
		</div><!-- /grid-b -->
	</div><!--ui-content-->
