<?php
/*
 * @file sandbox/jquerymobile/grid/grid2c.php
 ...
 * It is derived from grid2.php, by enlarging the vertical blocks.
...
<div data-role="page" id="page1" data-fullscreen="true"><!--page-->
	...
	<div role="main" class="ui-content"><!--ui-content-->
		...
		<div class="ui-grid-d">
			<div class="ui-block-a"><div class="ui-bar ui-bar-a" style="height:2000px">Block A</div></div>
			...
			<div class="ui-block-e"><div class="ui-bar ui-bar-a" style="height:2000px">Block E</div></div>
		</div><!-- /grid-b -->
	</div><!--ui-content-->
