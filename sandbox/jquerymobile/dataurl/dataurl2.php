...
<div data-role="page" id="page1" data-fullscreen="true"><!--page-->
	<div data-role="header" data-position="fixed" data-theme="d"><!-- header-->
		...
		<!--<a href="#/sandboxjqm/dataurl/tomato" data-role="button" rel="external" data-ajax="false" class="ui-btn ui-btn-inline ui-corner-all ui-shadow ui-icon-home ui-btn-icon-left">Pick Tomato</a>-->
		<!--<a href="#page3" data-role="button" rel="external" data-ajax="false" class="ui-btn ui-btn-inline ui-corner-all ui-shadow ui-icon-home ui-btn-icon-left">Pick Tomato</a>-->
		<a href="#page3" data-url="sandboxjqm/dataurl/tomato/" data-role="button" norel="external" data-ajax="true" class="ui-btn ui-btn-inline ui-corner-all ui-shadow ui-icon-home ui-btn-icon-left">Pick Tomato</a>
		<h1>Illusion</h1>
	</div><!--header-->
...
<div data-role="page" id="page3" data-url="sandboxjqm/dataurl/tomato.php" data-fullscreen="true"><!--page-->
	<div data-role="header" data-position="fixed" data-theme="d"><!-- header-->
		<a href="#page1" data-role="button" class="ui-btn ui-btn-inline ui-corner-all ui-shadow ui-icon-home ui-btn-icon-left">Illusion</a>
		<a href="#page1" data-role="button" class="ui-btn ui-btn-inline ui-corner-all ui-shadow ui-icon-gear">Page 1 Please</a>
		<h1>Tomato</h1>
