<?php
/*
 * @file sandbox/jquerymobile/prefetch/c/prefetch2.php
...
<div data-role="page" id="page2" data-dom-cache="false" data-fullscreen="true"><!--page-->
	...
	<div data-role="footer" data-fullscreen="true" data-id="std_postcard_footer"  data-position="fixed" data-theme="d"><!--footer-->
	  <a href="prefetch1.php" data-prefetch class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-btn-icon-right ui-icon-plus">Cancel</a>
	</div><!--footer-->
</div><!--page-->
</body>
</html>
