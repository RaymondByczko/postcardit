<?php
/*
 * @file sandbox/jquerymobile/m/multipaged4.php
 * @author Raymond Byczko
 * @company self
 * @purpose This page represents a multipage JQueryMobile entity.
 * It is a variant of multipaged2.php but contains pre content before
 * the collapsible as well as very long content after it.
 * No intentional bugs, like removing closing divs, were introduced
 * in this file.
 *
 * Lets see what happens with the pre collapsible content!
