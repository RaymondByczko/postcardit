<?php
/*
 * @file sandbox/jquerymobile/m/multipaged2.php
 * @author Raymond Byczko
 * @company self
 * @purpose This page represents a multipage JQueryMobile entity.
 * It is a variant of multipaged1.php but contains very long content
 * in one of the content sections.  No intentional bugs, like removing
 * closing divs, were introduced in this file.
 *
 * Lets see what happens with the very long content!
