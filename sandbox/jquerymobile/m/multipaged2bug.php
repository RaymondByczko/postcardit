<?php
/*
 * @file sandbox/jquerymobile/m/multipaged2bug.php
 * @author Raymond Byczko
 * @company self
 * @purpose This page represents a multipage JQueryMobile entity.

 * It is a variant of multipaged2.php, in that an intentional bug has
 * been introduced. The closing div has been removed from the second
 * collapsible content.
 *
 * Lets see what happens with the very long content! And the introduced bug.
 * @note The behavior does not seem to be impacted.  The href links work.
 * Perhaps its removal on the second one is the reason?
