...
<div data-role="page" id="page1" data-ajax="false" data-fullscreen="true"><!--page-->
	<div data-role="header" data-position="fixed" data-theme="b"><!-- header-->
...
<div data-role="page" id="page2" data-fullscreen="true"><!--page-->
	...
	<div data-role="footer" data-fullscreen="true" data-id="std_postcard_footer"  data-position="fixed" data-theme="b"><!--footer-->
	  <a href="#page_1" class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-btn-icon-right ui-icon-plus ui-disabled">Cancel</a>
	</div><!--footer-->
</div><!--page-->
</body>
